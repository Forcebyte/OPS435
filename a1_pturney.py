...
Program: pturney_a1.py (replace student_id with your Seneca User name)
...
def usage():
	...
	"""
	use = """
	Usage: a1_rchan.py [--step] YYYYMMDD +/-n
    ...
    e.g. a1_pturney.py 20190101 4
         a1_pturney.py --step 20180204 1
         a1_pturney.py --step 20180101 -2 
    """
	print (use)
	exit()
